    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image_url', models.FileField(default='static/images/postnoimage.png', upload_to='static/images/%Y')),
                ...
                ('company', models.ForeignKey(blank=True, help_text='Assign post to Company', on_delete=django.db.models.deletion.CASCADE, to='companies.Company')),
                ('ngo_or_npo', models.ForeignKey(blank=True, help_text='please assign post to NGO or NPO', on_delete=django.db.models.deletion.CASCADE, to='ngo_npo_profile.Organisation')),
            ],
        ),
        migrations.CreateModel(
            name='Opportunity',
            fields=[
                ...
                ('company_logo', models.FileField(default='/static/images/wecanchangeopportunity.jpg', upload_to='static/images/%Y/%m/%d')),
                ('Opportunity by Company', models.ManyToManyField(blank=True, help_text='Assign Opportunity to Company or leave blank', to='companies.Company')),
                ('Opportunity by NGO or NPO', models.ManyToManyField(blank=True, help_text='Assign Opportunity to NGO, NPO or leave blank', to='ngo_npo_profile.Organisation')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Event by Company', models.ManyToManyField(blank=True, help_text='Assign Event to Company or leave blank', to='companies.Company')),
                ('Event by NGO or NPO', models.ManyToManyField(blank=True, help_text='Assign Event to NGO, NPO or leave blank', to='ngo_npo_profile.Organisation')),
